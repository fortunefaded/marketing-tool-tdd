...
export class MetaDataCacheV2 {
  ...
  static mergeInsights(_existing: MetaInsightsData[], _newData: MetaInsightsData[]): MetaInsightsData[] {
  ...
  static findMissingDateRanges(_accountId: string, _start: string, _end: string): Array<{start: string, end: string}> {
