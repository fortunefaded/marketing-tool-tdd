...
export class KPIAggregator {
  ...
  private calculatePeriodComparison(
    ...
    currentMetrics.roas = currentMetrics.adSpend > 0 
      ? currentMetrics.revenue / currentMetrics.adSpend 
      : 0
    ...
    previousMetrics.roas = previousMetrics.adSpend > 0 
      ? previousMetrics.revenue / previousMetrics.adSpend 
      : 0
