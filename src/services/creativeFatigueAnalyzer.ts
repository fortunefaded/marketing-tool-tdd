...
export interface CreativeFatigueAnalysis extends FatigueAnalysis {}
...
export class CreativeFatigueAnalyzer {
  ...
  analyzeFatigue(creativeId: string, performanceData: CreativePerformanceData[]): FatigueAnalysis {
    ...
    const fatigueLevel = fatigueScore < 30 ? 'healthy' : 
                         fatigueScore < 60 ? 'warning' : 'critical'
  ...
  private calculateFatigueScore(
    ...
    const score = (
      ...
      frequencySaturation * frequencyWeight +
