...
describe('InteractiveDashboard', () => {
  const mockWidgets = [
    { id: '1', type: 'sales-chart', title: '売上推移', position: { x: 0, y: 0 }, size: { width: 6, height: 4 } },
    { id: '2', type: 'customer-pie', title: '顧客分布', position: { x: 6, y: 0 }, size: { width: 6, height: 4 } },
    { id: '3', type: 'kpi-card', title: '主要KPI', position: { x: 0, y: 4 }, size: { width: 3, height: 2 } }
  ]
  ...
  it('ウィジェットが重ならないように自動配置される', () => {
    const overlappingWidgets = [
      { id: '1', type: 'sales-chart', title: 'A', position: { x: 0, y: 0 }, size: { width: 6, height: 4 } },
      { id: '2', type: 'kpi-card', title: 'B', position: { x: 2, y: 2 }, size: { width: 6, height: 4 } }
    ]
