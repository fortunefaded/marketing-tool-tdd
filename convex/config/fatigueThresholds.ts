...
export const SCORE_WEIGHTS = {
  audience: 0.40,   // 40%の重み - オーディエンス疲労
...
export const RECOMMENDED_ACTIONS = {
  audience: {
    critical: "オーディエンスの飽和が深刻です。新しいターゲティングセグメントの追加、またはキャンペーンの一時停止を検討してください。",
    warning: "オーディエンスに疲労の兆候が見られます。フリークエンシーキャップの設定を検討してください。",
    caution: "オーディエンスへの配信頻度に注意が必要です。今後の推移を監視してください。"
  },
  creative: {
    critical: "クリエイティブの効果が大幅に低下しています。新しいクリエイティブへの差し替えを強く推奨します。",
    warning: "クリエイティブのパフォーマンスが低下傾向です。A/Bテストで新しいバリエーションを試してください。",
    caution: "クリエイティブに軽度の疲労兆候があります。バリエーションの追加を検討してください。"
  },
  algorithm: {
    critical: "アルゴリズムの配信効率が悪化しています。入札戦略の見直し、またはキャンペーンの再構築を検討してください。",
