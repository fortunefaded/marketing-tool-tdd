...
export const getContextualThresholds = query({
  ...
  handler: async (_ctx, args) => {
    const { industry = 'b2c_ecommerce', productPrice = 100, campaignGoal = 'conversions', season = 'normal' } = args
...
export const getIndustryRecommendations = query({
  ...
  handler: async (_ctx, args) => {
    ...
    return recommendations[args.industry as keyof typeof recommendations] || recommendations.b2c_ecommerce
  }
})